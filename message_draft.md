...
Follow @0_core_guidelines.md : create refactor plan for llm-direct testbeds and codebase restructure
Step 0: Do all preparation steps (read all #0_core_guidelines.md, review and update the latest user understanding log, review and update centralized configs, review and update ai short term memory)
Step 1: Do task 1 (#...)
Step 2: Do task 2 (#...)
